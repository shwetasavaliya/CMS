...
var UserController = /** @class */ (function () {
    ...
    UserController.prototype.register = function (request, response, body) {
        return __awaiter(this, void 0, void 0, function () {
            var email, password, firstName, lastName, phone, city, state, country, userExists, userData, error_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 3, , 4]);
                        email = body.email, password = body.password, firstName = body.firstName, lastName = body.lastName, phone = body.phone, city = body.city, state = body.state, country = body.country;
                    ...
                    case 2:
                        _a.sent();
                        return [2 /*return*/, response.formatter.ok(userData, true, 'USER_REGISTER_SUCCESS')];
                    case 3:
                        error_1 = _a.sent();
